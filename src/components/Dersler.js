...
class Dersler extends Component {
  ...
  onAddLesson = (dispatch, e) => {
    var newLesson = {
      ...
      lesson: {
        dersid: document.forms[3][1].value,
        yoklamakodu: "",
        dersadi: document.forms[3][0].value,
        bolumadi: document.forms[3][3].value,
        yil: document.forms[3][5].value,
        sinif: document.forms[1][6].value,
        ogrencilistesi: [],
      },
    };
  ...
  onEditLesson = (dispatch, e) => {
    ...
    var newLesson = {
      ...
      lesson: {
        ...
        yoklamakodu: "",
        dersadi: "",
        bolumadi: document.forms[4][5].value,
        yil: document.forms[4][5].value,
        sinif: document.forms[2][7].value,
        ...
        {(value) => {
          ...
          return (
            <div>
              <div
                className="card"
                style={isVisible ? { backgroundColor: "#AEF0FF" } : null}
              >
                  ...
                  <div className="modal-content">
                    <div className="modal-header">
                      ...
                      <button
                        type="button"
                        className="close"
                        data-dismiss="modal" //tıklandığında gizle
                        aria-label="Close"
                      >
                        <span aria-hidden="true">&times;</span>
                      </button>
